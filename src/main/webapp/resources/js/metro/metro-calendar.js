...
(function( $ ) {
    $.widget("metro.calendar", {
        ...
        _renderMonth: function(){
            ...
            $("<td/>").addClass("text-center").html("<a class='btn-previous-year' href='#'><i class='fa  fa-arrow-circle-o-left'></i></a>").appendTo(tr);
            $("<td/>").addClass("text-center").html("<a class='btn-previous-month' href='#'><i class='fa  fa-caret-left'></i></a>").appendTo(tr);
            ...
            $("<td/>").addClass("text-center").html("<a class='btn-next-month' href='#'><i class='fa  fa-caret-right'></i></a>").appendTo(tr);
            $("<td/>").addClass("text-center").html("<a class='btn-next-year' href='#'><i class='fa  fa-arrow-circle-o-right'>").appendTo(tr);
        ...
        _renderMonths: function(){
            ...
            $("<td/>").addClass("text-center").html("<a class='btn-previous-year' href='#'><i class='fa  fa-caret-left'></i></a>").appendTo(tr);
            $("<td/>").attr("colspan", 2).addClass("text-center").html("<a class='btn-select-year' href='#'>"+this._year+"</a>").appendTo(tr);
            $("<td/>").addClass("text-center").html("<a class='btn-next-year' href='#'><i class='fa  fa-caret-right'></i></a>").appendTo(tr);
